...
def binary_search(lista, beginning, end, objective):
    if beginning > end:
        return False
    ...
    if lista[middle] == objective:
        ...
        return binary_search(lista, middle + 1, end, objective)
    else:
        return binary_search(lista, beginning, middle - 2, objective)
...
if __name__ == '__main__':
    ...
    found = binary_search(lista, 0, len(lista), objective)
